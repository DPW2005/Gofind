    ...
    <body> 
        <div class="form-container">
            <form method="post" action="objet" id="signUpForm">
                ...
                <div class="form-group">
                    <label for="imei">IMEI/MAC</label>
                    <input type="text" id="imei" name="id" required/>
                </div>
                <div class="form-group">
